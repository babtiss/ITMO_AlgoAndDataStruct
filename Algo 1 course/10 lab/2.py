'''
1.  Алгоритм Прима,
на массиве + списках смежности(матрице смежности) == O(V^2)
на двоичной куче + списках смежности == O(E + Vlog(V) )
На каждой итерации:
    1) Ищем вершину с минимальным расстояние до неё от стартовой вершины (dist).
    2) Отмечаем эту вершину как посещённую, чтоб больше её не трогать (viz).
    3) Обновим минимальной расстояние до вершин-соседей к данной (dist).
